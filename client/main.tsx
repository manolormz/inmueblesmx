...
banner.style.cssText = "position:fixed;left:8px;bottom:8px;background:#E7E3D0;color:#1F1F1B;padding:6px 10px;border-radius:12px;font:12px/1.2 Inter,system-ui;z-index:99999;opacity:.85";

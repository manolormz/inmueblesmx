      ...
      <div className="max-w-lg mx-auto bg-white border rounded-2xl p-4 space-y-3">
        ...
        >
          ...
          <FormField
            label="Slug"
            required
            hint="Identificador único en URL"
          ...
          >
            <Input
              ...
              onChange={(e) => {
                ...
                (register("slug").onChange as any)(e);
              }}
            />
          </FormField>
          ...
          />
          <ActionBar
            primaryText={isSubmitting ? "Registrando…" : "Registrar"}
            busy={isSubmitting}
          />
        </form>
      </div>

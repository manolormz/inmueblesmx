      ...
      <main className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <div>
            ...
            <Select
              onValueChange={(v) =>
                setValue("operation", v, { shouldValidate: true })
              }
            >
              <SelectTrigger>
                <SelectValue placeholder="Seleccionar" />
          ...
          <div>
            ...
            <Input
              type="number"
              min={0}
              {...register("land_m2", { valueAsNumber: true })}
            />
          </div>
          ...
          <div>
            ...
            <Input
              type="number"
              step="any"
              {...register("geo_lat", { valueAsNumber: true })}
            />
          </div>
          <div>
            ...
            <Input
              type="number"
              step="any"
              {...register("geo_lng", { valueAsNumber: true })}
            />
          </div>

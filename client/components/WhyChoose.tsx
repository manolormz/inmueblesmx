  ...
  const features = [
    {
      ...
      text: "Accede a propiedades con el mejor valor del mercado.",
    },
    {
      icon: "📍",
      title: "Expertos locales",
      text: "Agentes certificados en cada región del país.",
    },
    {
      icon: "🔒",
      title: "Proceso seguro",
      text: "Transacciones verificadas y protegidas legalmente.",
    },
  ];
  return (
    <section className="bg-secondary/40 rounded-2xl py-12 mt-12 text-center">
      ...
      <p className="mt-3 text-gray-700">
        Confianza, seguridad y un enfoque humano para tu próxima inversión
        inmobiliaria.
      </p>
